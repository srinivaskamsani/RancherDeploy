...
class Rancher:
    ...
    def create_new_service(self, stack_id, service_name, imageUuid, env_vars, ports):
        ...
        print("export " + "TEST_SERVER_HOST=" + eps['publicEndpoints'][0]['ipAddress'])
        print("export " + "TEST_SERVER_PORT=" + str(eps['publicEndpoints'][0]['port']))
        return raw_resp
    ...
    def upgrade_service(self, service_id, imageUuid, env_vars, ports):
        ...
        print("export " + "TEST_SERVER_HOST=" + eps['ipAddress'])
        print("export " + "TEST_SERVER_PORT=" + str(eps['port']))
